...
def play_game():
    ...
    def compare(user_score, computer_score):
        if user_score == computer_score:
            ...
            return "Lost, Computer got BLACKJACK!"
        elif user_score == 0:
            return "Winner, you got BLACKJACK!"
        elif user_score > 21:
            return "Lost, went over 21"
    ...
    print(f"You final hand is {user_cards}, with the score {user_score} ")
    print(
        f"The computers final hand is {computer_cards}, with the score {computer_score} "
    )
